...
export default {
  ...
  methods: {
    ...
    hapusKeranjang(id) {
      axios
        .delete("https://61bc3a72d8542f0017824619.mockapi.io/keranjang/" + id)
        .then(() => {
          ...
          axios
            .get("https://61bc3a72d8542f0017824619.mockapi.io/keranjang")
    ...
    checkout() {
      if (this.pesan.nama && this.pesan.noMeja) {
        ...
        axios
          .post(
            "https://61bc3a72d8542f0017824619.mockapi.io/pesanans",
            this.pesan
          )
          .then(() => {
            ...
            this.$toast.success("Sucess Dipesan.", {
              type: "success",
              position: "top-right",
              duration: 3000,
              dismissible: true,
